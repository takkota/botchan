...
class BotDetailController {
    ...
    fun saveBotDetail(@RequestBody body: BotDetailSaveParameter) {
        botService.saveBotDetail(id = body.id, userId = body.userId, groupIds = body.groupIds, replyCondition=  body.replyCondition, pushCondition = body.pushCondition, message = body.message)
    }
